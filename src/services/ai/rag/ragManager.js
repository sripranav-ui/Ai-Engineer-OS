...
export class RAGManager {
  ...
  async enqueueFile(file) {
    ...
    const docRecord = {
      ...
      extension: parsed.extension || parsed.type,
      mimeType: parsed.mimeType || "text/plain",
      size: parsed.size || parsed.text.length,
      type: parsed.type,
      pageCount: parsed.pageCount,
      characterCount: parsed.characterCount || parsed.text.length,
      ...
      hash: parsed.hash || parsed.contentHash,
      status: "Queued",
